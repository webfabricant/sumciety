        ...
        <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item dropdown notification-list hidden-xs-down">
                <a class="nav-link dropdown-toggle arrow-none waves-effect text-muted" data-toggle="dropdown" href="#" role="button"
                   aria-haspopup="false" aria-expanded="false">
                    English <img src="{{ asset('backend/assets/images/flags/us_flag.jpg')}}" class="ml-2" height="16" alt=""/>
                </a>
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <a class="dropdown-item" href="{{route('artist.profile')}}"><i class="dripicons-user text-muted"></i> Profile</a>
                    ...
                    <div class="dropdown-divider"></div>
                     <a class="dropdown-item" href="{{ route('logout') }}"
                           onclick="event.preventDefault();
                            ...
                            <i class="dripicons-exit text-muted"></i> {{ __('Logout') }} </a>
