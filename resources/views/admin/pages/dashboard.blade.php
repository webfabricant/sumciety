                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vertical mb-0">
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                    Herbert C. Patton
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                    Mathias N. Klausen
                                </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-vertical mb-0">
                            ...
                            <tr>
                                <td>#12354781</td>
                                <td>
                                    <img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="user-image" style="height: 46px;" class="rounded mr-2" />
